...
"""
Installation script for TTM's development virtualenv
"""
...
def print_help():
    help = """
    TTM development environment setup is complete.

    TTM development uses virtualenv to track and manage Python dependencies
    while in development and testing.

    To activate the TTM virtualenv for the extent of your current shell
    session you can run:
